...
while True:
    # increase the asteroid clock by the clock
    asteroid_clock += clock.get_time()
    ...
    for asteroid in asteroids:        
        # if collide with player, end game
        if ship.colliderect(asteroid):         # NEW
            print("Game Over!")                # NEW
            pygame.quit()                      # NEW
            sys.exit()
